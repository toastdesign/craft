...
function watch() {
  ...
  gulp.watch('public/src/assets/scss/**/*.scss').on('all', sass);
  gulp.watch('**/*.html').on('all', browser.reload);
  gulp.watch('**/*.php').on('all', browser.reload);
  gulp.watch('public/src/assets/js/**/*.js').on('all', gulp.series(javascript, browser.reload));
  gulp.watch('public/src/assets/img/**/*').on('all', gulp.series(images, browser.reload));
}
